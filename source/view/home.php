                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>T&M</b> Store Apps</h1>
                                <h3 class="h2">
                                    Formerly Android Market, is a digital distribution service operated and developed by
                                    Ms.My & Mr.Thang.
                                </h3>
                                <p>
                                    T&M Store Apps also serves as a digital media store, offering music, books, movies,
