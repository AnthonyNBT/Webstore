                ...
                <div class="card p-xl-3 border-success">
                    <div class="e-navlist e-navlist--active-bg">
                        <ul class="nav d-md-block">
                            <li class="nav-item"><a class="nav-link px-2 active font-weight-bold"><i class="fa fa-fw fa-bar-chart mr-1"></i><span>Thiết lập</span></a></li>
                            <li class="nav-item"><a class="nav-link px-2 text-success" href="coin.php"><i class="fa fa-fw fa-th mr-1"></i><span>Nạp tiền</span></a></li>
                            <li class="nav-item"><a class="nav-link px-2 text-success" href="upgrade.php"><i class="fa fa-fw fa-cog mr-1"></i><span>Nâng cấp</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="e-profile">
                                    ...
                                    <div class="tab-content pt-3">
                                        <div class="tab-pane active">
                                            <form action="../controller/ProfileAccess.php" class="form" novalidate="" method="POST">
                                                <div class="row">
                                                    <div class="col">
                                                        <!--Start Fullname-->
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control change-info" type="text" name="name" placeholder="Name" value="<?=$row["FULLNAME"]?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/End Fullname-->
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label>Email</label>
                                                                    <input class="form-control" type="text" placeholder="email@gmail.com" name="mail" value="<?=$row["EMAIL"]?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/End Email-->
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control change-info" type="date" name="birth" value="<?= $row["BIRTH"] ?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/End Birth-->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <button class="btn btn-success d-none" type="submit" id="btn-Info">Lưu thay đổi</button>
                                                    </div>
                                                </div>
