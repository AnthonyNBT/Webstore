...
<div class="container py-5">
    <div class="row">
        <!-- Start Sidebar Left-->
        <div class="col-lg-3">
            <h1 class="h2 pb-4">Danh sách ứng dụng trả phí phổ biến nhất</h1>
            <?php include "./frame/top-sidebar.php";?>
        </div>
        <!--/ End Sidebar Left-->
        <!-- Start Content-->
        <?php include "./frame/top-content.php";?>
        <!-- / End Content-->
    </div>
</div>
<!-- End Content -->
