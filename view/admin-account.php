...
<head>
    <title>Team 5 | Tài khoản QTV</title>
    <meta charset="utf-8">
...
<body>
<!-- Header -->
<?php include "../view/frame/admin-header.php";?>
<!-- / End Header -->
            ...
            <div class="card p-xl-3 border-success">
                <div class="e-navlist e-navlist--active-bg">
                    <ul class="nav d-md-block">
                        ...
                        <li class="nav-item"><a class="nav-link px-2 text-success" href="admin-coin.php" target="_blank"><i class="fab fa-bitcoin mr-2"></i><span>Mã thẻ</span></a></li>
                        <li class="nav-item"><a class="nav-link px-2 text-success" href="admin-type.php" target="_blank"><i class="fas fa-bars mr-2"></i><span>Loại ứng dụng</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="row">
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            <div class="e-profile">
                                    ...
                                    <div class="col-12 col-sm-auto mb-3">
                                        <div class="mx-auto account-img">
                                            <div class="d-flex justify-content-center align-items-center rounded account-img-custom">
                                                <span class="account-img-title">
                                                <img src="../data/users/admin/images/avatar.jpg" alt="Avatar">
                                                </span>
                                            </div>
                                ...
                                <ul class="nav nav-tabs pt-3">
                                    <li class="nav-item">
                                        <a class="active nav-link text-success font-weight-bolder">Tài khoản quản trị viên</a>
                                    </li>
                                </ul>
                                <!--Start Content-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control change-info" type="text" name="name" placeholder="Admin" value="<?=$row["FULLNAME"]?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--/End Fullname-->
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                                <input class="form-control" type="text" placeholder="admin@gmail.com" value="admin@gmail.com" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--/End Email-->
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control change-info" type="date" value="<?= $row["BIRTH"] ?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--/End Birth-->
                        ...
                        <div class="card-body">
                            <div class="e-profile">
                                ...
                                <div class="tab-content pt-3">
                                    <div class="tab-pane active">
                                        <form action="../controller/ChangeAccess.php" class="form" novalidate="" method="POST">
                                            <!--Start Mật khẩu cũ-->
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>Nhập mật khẩu cũ</label>
                                                        <input name="OldPass" class="form-control ch-pass" type="password" placeholder="••••••" disabled>
                                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="NewPass" class="form-control ch-pass" type="password" placeholder="••••••" disabled>
                                                                <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="NewPass2" class="form-control ch-pass" type="password" placeholder="••••••" disabled>
                                                                <div>
                                            ...
                                            <div class="row">
                                                <div class="col d-flex justify-content-end" >
                                                    <button class="btn btn-success d-none" type="submit" id="btn-Pass">Lưu mật khẩu</button>
                                                </div>
                                            </div>
                ...
                <div class="col-12 col-sm-3 mb-3">
                    <div class="card border-success">
                        <div class="card-body">
                            <h5 class="text-center font-weight-bold">Phản hồi</h5>
                            <p class="card-text text-center">Nội dung người dùng liên hệ QTV</p>
                            <a class="nav-link px-2 text-success text-center pt-0" href="admin-contact.php" target="_blank"><i class="far fa-address-book"></i></i><span>&nbsp;&nbsp;Xem ngay</span></a>
                        </div>
                    </div>
                </div>
                <!--/End Trợ giúp-->
